...
begin_implement_rux_class_ns( Sslv2ClientHello , rux::network );
...
namespace rux
{
	namespace network
	{
		void XSslv2ClientHello::AddCipherSuite( XEnum_TlsCipherSuite tls_cipher_suite )
		{
			rux::uint32 index0 = 0;
		...
		rux::uint32 XSslv2ClientHello::get_PacketSize( void )
		{	
			return 41 + (*this)()->_session_id_length + 3 * (*this)()->_cipher_suites.Count();
		/*
			1 //HandshakeType
				3//Length
				1//major
		...
		*/
		...
		void XSslv2ClientHello::set_Random( rux::uint8 random[ 28 ] )
		{
			memcpy( &(*this)()->_random[ 4 ] , random , 28 );
		};
		const rux::uint8* XSslv2ClientHello::get_Random( void )
		{
			return (*this)()->_random;
		};
		rux::uint32 XSslv2ClientHello::get_RandomLength( void )
		{
			return 32;
		};
	};
